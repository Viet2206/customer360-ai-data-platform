...
.PHONY: help install format lint test test-all up up-search up-ai up-apps down logs smoke compose-check clean
...
up-search: ## Start PostgreSQL and the OpenSearch document index
	docker compose --profile ai up -d --wait postgres opensearch
